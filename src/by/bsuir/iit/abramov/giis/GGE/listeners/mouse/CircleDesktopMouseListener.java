...
public class CircleDesktopMouseListener implements MouseListener {
	...
	public CircleDesktopMouseListener(final DesktopController controller, final Desktop desktop) {
	...
	public void mouseClicked(final MouseEvent e) {
		...
		if (isLeftButtonPressed(e)) {
			desktop.setCirclePoint(e.getX() - desktopCenter.x, e.getY() - desktopCenter.y);
