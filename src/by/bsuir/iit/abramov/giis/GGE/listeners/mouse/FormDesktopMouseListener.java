...
public class FormDesktopMouseListener implements MouseListener {
	...
	public FormDesktopMouseListener(final DesktopController controller, final Desktop desktop) {
	...
	public void mouseClicked(final MouseEvent e) {
		...
		if (isLeftButtonPressed(e)) {
			desktop.setFormPoint(e.getX() - desktopCenter.x, e.getY() - desktopCenter.y);
